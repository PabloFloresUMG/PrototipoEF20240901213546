            ...
            try
            {
                ...
                if (resultadoEncabezado)
                {
                    ...
                    if (resultadoDetalle)
                    {
                        ...
                        logicaSeg.funinsertarabitacora(idUsuario, "se asignó orden", "tbl_proceso_produccion_encabezado", "1001");
                        logicaSeg.funinsertarabitacora(idUsuario, "se asignó orden", "tbl_proceso_produccion_detalle", "1001");
                    }
                    else
                    {
